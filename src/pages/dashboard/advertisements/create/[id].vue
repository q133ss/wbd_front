...
// Вычисляемый массив полей textarea с фильтрацией по isKeywords
      ...
      <div v-else-if="product">
        ...
        <div class="ad-form">
          <VForm @submit.prevent="submitAd">
            ...
            <!-- Текстовые поля с условием скрытия "Инструкций для выкупа" -->
            <VRow
            ...
            <div v-if="isKeywords">
              ...
              <div class="mt-4 text-subtitle-1 grey--text mb-4">
