...
const openBotText = userData.value.telegram_id == undefined ? 'Подключить' : 'Подключено'
</script>
  ...
  <VContainer>
    ...
    <VRow class="mt-6">
      ...
      >
        ...
        <VCard
          v-if="role === 'buyer'"
          title="Платежные данные для кэшбека"
          class="mt-6"
        >
          <VCardText>
            <VForm @submit.prevent="updateProfile">
              ...
              >
                <template #prepend>
                  <span class="prepend-icon">
                    ...
                    >
                      <path
                        d="M4 8.70679L8.844 17.3651V22.6464L4.00567 31.2878L4 8.70679Z"
                        fill="#5B57A2"
                      />
                      <path
                        d="M22.5989 14.2145L27.1379 11.4325L36.4272 11.4238L22.5989 19.8952V14.2145Z"
                        fill="#D90751"
                      />
                      <path
                      ...
                      />
                      <path
                        d="M22.599 31.3357V25.7741L17.7437 22.8474L17.7463 40.0001L22.599 31.3357Z"
                        fill="#63B22F"
                      />
                      <path
                        d="M27.1266 28.5791L8.84366 17.3651L4 8.70679L36.4076 28.5678L27.1263 28.5791H27.1266Z"
                        fill="#1487C9"
                      />
                      <path
                        d="M17.7468 39.9999L22.5988 31.3356L27.1265 28.579L36.4075 28.5676L17.7468 39.9999Z"
                        fill="#017F36"
                      />
                      <path
                        d="M4.00562 31.2876L17.7833 22.8476L13.1513 20.0056L8.84394 22.6463L4.00562 31.2876Z"
                        fill="#984995"
                      />
                    </svg>
                  </span>
              ...
              >
                <template #prepend>
                  <span class="prepend-icon">
                    ...
                    >
                      <path
                        d="M35.3517 7.77026C36.2892 8.99861 37.0828 10.3331 37.7165 11.7469L19.7398 25.1769L12.2268 20.404V14.6619L19.7398 19.4349L35.3517 7.77026Z"
                        fill="#21A038"
                      />
                      <path
                        d="M4.55927 19.9993C4.55927 19.7417 4.56547 19.4857 4.57787 19.2312L0.0247968 19.0051C0.00929965 19.3349 5.50217e-06 19.6679 5.50217e-06 20.004C-0.0019317 22.6298 0.507688 25.23 1.49964 27.6556C2.49159 30.0813 3.94634 32.2846 5.78045 34.1391L9.01005 30.8677C7.59822 29.4426 6.47822 27.7488 5.7144 25.8836C4.95058 24.0185 4.55802 22.0187 4.55927 19.9993Z"
                        fill="url(#paint0_linear_1595_21748)"
                      />
                      <path
                        d="M19.7358 4.62042C19.9899 4.62042 20.2424 4.62985 20.4935 4.64241L20.7213 0.0265021C20.3949 0.0107964 20.0663 0.00294452 19.7358 0.00294452C17.1436 -0.000259062 14.5765 0.515474 12.1817 1.52053C9.78683 2.52559 7.61148 4.00017 5.78052 5.85962L9.01012 9.13268C10.4163 7.70139 12.0878 6.5659 13.9285 5.79152C15.7692 5.01715 17.7427 4.61915 19.7358 4.62042Z"
                        fill="url(#paint1_linear_1595_21748)"
                      />
                      <path
                        d="M19.7357 35.3798C19.4815 35.3798 19.2289 35.3798 18.9764 35.3594L18.7485 39.9737C19.076 39.9904 19.4051 39.9989 19.7357 39.9989C22.3267 40.0016 24.8926 39.4855 27.2861 38.4802C29.6797 37.4748 31.8536 36 33.6832 34.1406L30.4598 30.8691C29.0533 32.2997 27.382 33.4345 25.5417 34.2086C23.7014 34.9827 21.7282 35.3808 19.7357 35.3798Z"
                        fill="url(#paint2_linear_1595_21748)"
                      />
                      <path
                        d="M28.2905 7.30319L32.1275 4.43689C28.6204 1.55876 24.2426 -0.00798939 19.7297 3.06379e-05V4.61908C22.7856 4.61524 25.7706 5.55117 28.2905 7.30319Z"
                        fill="url(#paint3_linear_1595_21748)"
                      />
                      <path
                        d="M39.47 20.0001C39.4724 18.7985 39.3687 17.5989 39.16 16.416L34.9123 19.5886C34.9123 19.7253 34.9123 19.8619 34.9123 20.0001C34.9134 22.1491 34.4688 24.2743 33.6077 26.238C32.7464 28.2017 31.4876 29.9601 29.9128 31.3992L32.9767 34.831C35.0239 32.9579 36.6599 30.6698 37.7785 28.1149C38.8972 25.5599 39.4734 22.7952 39.47 20.0001Z"
                        fill="#21A038"
                      />
                      <path
                        d="M19.7358 35.3804C17.6152 35.3811 15.5181 34.9305 13.5801 34.0577C11.6423 33.1849 9.90692 31.9093 8.48638 30.3137L5.10181 33.4172C6.94978 35.4923 9.20748 37.1505 11.7285 38.2845C14.2495 39.4184 16.9776 40.0027 19.7358 39.9994V35.3804Z"
                        fill="url(#paint4_linear_1595_21748)"
                      />
                      <path
                        d="M9.55867 8.60016L6.49642 5.16846C4.44858 7.04117 2.81201 9.3292 1.69285 11.8842C0.573697 14.4391 -0.0030512 17.2039 1.21392e-05 19.9993H4.55928C4.55834 17.8505 5.0029 15.7252 5.86412 13.7615C6.72535 11.7978 7.98405 10.0394 9.55867 8.60016Z"
                        fill="url(#paint5_linear_1595_21748)"
                      />
                      <defs>
                        <linearGradient
                          id="paint0_linear_1595_21748"
                          x1="6.70253"
                          y1="33.5628"
                          x2="1.60155"
                          y2="19.0127"
              ...
              >
                <template #prepend>
                  <span class="prepend-icon">
                    ...
                    >
                      <path
                        d="M0 0H40.0001V20.1171C40.0001 25.2743 37.2489 30.0398 32.7829 32.6186L20 40L7.21719 32.6186C2.75113 30.0398 0 25.2743 0 20.1171V0Z"
                        fill="#FFDD2D"
                      />
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                        d="M10.9783 10.5891V16.846C11.8339 15.8798 13.3895 15.2259 15.1682 15.2259H17.1011V22.4994C17.1011 24.4345 16.5753 26.1283 15.7952 27.0599H24.2029C23.4244 26.1273 22.8998 24.4357 22.8998 22.5031V15.2259H24.8328C26.6115 15.2259 28.1671 15.8798 29.0227 16.846V10.5891H10.9783Z"
                        fill="#333333"
                      />
                    </svg>
                  </span>
              ...
              >
                <template #prepend>
                  <span class="prepend-icon">
                    ...
                    >
                      <path
                        d="M7 34.53H33.29V40H7V34.53ZM14.82 21.62H25.19L26.94 27.12H32.69L24.93 4C24.18 1.78 23.31 0 20.34 0C17.37 0 16.46 1.75 15.68 4L7.56 27.11H12.95L14.82 21.62V21.62ZM20.08 6H20.21L23.7 17H16.4L20.08 6V6Z"
                        fill="#EF3124"
                      />
                    </svg>
              ...
              >
                <template #prepend>
                  <span class="prepend-icon">
                    ...
                    >
                      <path
                        d="M8.95505 8L6.71401 14.1472H37.759L40 8H8.95505ZM5.59479 17.2182L3.35375 23.3642H34.3987L36.6397 17.2182C36.6397 17.2182 5.59479 17.2182 5.59479 17.2182ZM2.24104 26.4365L0 32.5811H31.0449L33.2834 26.4352C33.2847 26.4365 2.24104 26.4365 2.24104 26.4365Z"
                        fill="#009FDF"
                      />
                    </svg>
      ...
      >
        <VCard title="Уведомления">
          <VCardText v-if="!userData?.telegram_id">
            ...
            <p class="text-center mt-4">
              Отсканируйте QR-код для подключения к Telegram-боту
            </p>
          </VCardText>
          <VCardActions class="d-flex justify-center mb-4">
            <div class="text-center">
              <VBtn
                variant="outlined"
                color=""
                :disabled="userData?.telegram_id"
            ...
            <VRow>
              ...
              <VCol cols="6">
                <VCard class="text-center pa-4">
                  ...
                  >
                    {{ statistics.cashback_paid }}
                  </VCardTitle>
                  <VCardText v-if="role === 'seller'">
                    Кэшбэка выплаченно
                  </VCardText>
                  <VCardText v-else>
                    Кэшбэка полученно
              ...
              <VCol cols="6">
                <VCard class="text-center pa-4">
                  ...
                  >
                    {{ parseInt(statistics.average_response_time) }} мин.
                  </VCardTitle>
